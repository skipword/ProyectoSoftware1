...
// Elementos del modal de confirmación de compra
...
// Evento para mostrar el modal de compra al hacer clic en "Comprar Combo"
if (btnComprarCombo) {
    btnComprarCombo.addEventListener('click', showModalCompra);
}

// Eventos para confirmar o cancelar la compra
